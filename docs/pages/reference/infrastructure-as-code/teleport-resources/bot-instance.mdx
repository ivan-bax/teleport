...
|Field Name|Description|Type|
|---|---|---|
|gce|Attributes specific to the GCP join method when the joining entity is on a GCE instance. This may not be present if the joining entity is not on GCE.|[Join Attrs GCP GCE](#join-attrs-gcp-gce)|
